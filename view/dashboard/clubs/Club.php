...
$rows=ClubController::getClubData();
    ...
    <div class="flex flex-col flex-1 overflow-y-auto">
        ...
        <div class="flex justify-evenly items-center "> 
          ...
          <div class="btnAjouter">
               <button id="btnAjouter" class="h-10 w-24 bg-blue-600 text-white rounded shadow-lg">Add Club</button>
          </div>
        ...
        <!-- <div class="overflow-x-auto"> -->
            <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                <thead class="bg-gray-800 text-white">
                    <tr>
                        <th class="py-2 px-4">club_id</th>
                        <th class="py-2 px-4">clubName</th>
                        <th class="py-2 px-4">club_img</th>
                ...
                <tbody>
                  ...
                  ?>
                    <tr class="border-b">
                        <td class="py-2 px-4"><?php echo $row['club_id']; ?></td>
                        <td class="py-2 px-4"><?php echo $row['clubName']; ?></td>
                        <td class="py-2 px-4"><img src="../../../app/uploads/players/natio/<?php echo $row['club_img']; ?>" alt=""></td>
                        <td class="py-2 px-4">
                            <a href="UpdateClub.php?club_id=<?php echo $row['club_id']; ?>" class="text-blue-500 hover:underline"><i class="fa-solid fa-pencil"></i></a> |
                            <a href="Club.php?id=<?php echo $row['club_id']; ?>" class="text-red-500 hover:underline"><i class="fa-solid fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                      }
                ...
                <div id="form-child">
                    <form id="form" method="POST" enctype="multipart/form-data" class="max-w-md mx-auto shadow-lg rounded-lg p-4 space-y-4"
                        ...
                        <div>
                            ...
                            <input type="text" id="clubName" placeholder="RCA" name="clubName"
                                class="w-full mt-1 p-2 border rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
                            <span id="errorFullname" class="hidden">errorclubName</span>
                        </div>
                        ...
                        <div class="relative w-full mb-8 border p-1 rounded-lg">
                            ...
                            <div class="flex items-center justify-center w-full">
                                <label for="profileImage"
                                    ...
                                    <input id="profileImage" type="file" name="club_img" accept="image/*" class="hidden" />
                                </label>
                            </div>
                        </div>
                        <button type="submit" id="add" name="addClub"
