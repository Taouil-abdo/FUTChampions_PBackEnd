                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <td class="py-2 px-4"><?php echo $row['FullName']; ?></td>
                        ...
                        <td class="py-2 px-4">
                        <a href="players/updatePlayer.php?id=<?php echo $row['player_id']; ?>" class="text-blue-500 hover:underline"><i class="fa-solid fa-pencil"></i></a>
                            <a href="dashboard.php?id=<?php echo $row['player_id']; ?>" class="text-red-500 hover:underline"><i class="fa-solid fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                      }
